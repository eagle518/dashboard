...
<p>
<input type="button" style="width:100%" onclick="location.href='http://bi.rosetech.cn/frame/Frame3.action?token=<%=request.getParameter("token")%>'" value="PC端访问：http://bi.rosetech.cn">
