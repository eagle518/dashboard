...
public class LoginAction {
	...
	public String login() throws IOException, ServletException {
		...
		if (!returnStatus) {
			...
			VDOPUtils.getRequest().setAttribute("user",VDOPUtils.getLoginedUser());
		...
		**/
		...
		if (temName.equals(userName)) {// 开始进行身份验证
			...
			if (flag) {
				...
				VDOPUtils.saveLoginedUser(u, VDOPUtils.getRequest(), VDOPUtils.getServletContext());// user 对像存入session
